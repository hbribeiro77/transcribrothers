...
export async function regenerarMarkdownNotasPropostaJobApiTranscribrothers(
  jobId: string,
  opcoes: {
  ...
  const r = await fetch(`/api/jobs/${encodeURIComponent(jobId)}/regenerate-notas-proposta`, {
    method: "POST",
